...
SECRET_KEY = 'django-insecure-yu1uuucv2x2q33@2uvxg)p+k2@lg72qz1c#@xy^v-!d#_dfmld'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'libraries': {
                'custom_filters': 'reservas.templatetags.custom_filters',
            },
            'context_processors': [
...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'nyxsoftware.ml@gmail.com'
EMAIL_HOST_PASSWORD = 'tzjr wmfv mnxd gkay'
EMAIL_USE_TLS = True
...
MERCADOPAGO_USE_SANDBOX = os.getenv('MERCADOPAGO_USE_SANDBOX', 'true').lower() == 'true'
